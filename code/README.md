...
인기 아이돌 그룹의 콘서트 티켓 예매 일정을 한눈에 확인할 수 있는 웹 서비스

## 프로젝트 소개

CrazyMonth는 NOL 티켓과 멜론 티켓에서 16개 인기 아이돌 그룹의 콘서트 예매 일정을 자동으로 수집하여 달력 형태로 보여주는 웹사이트입니다.

### 주요 기능

- 📅 **통합 달력**: 여러 티켓 사이트의 예매 일정을 하나의 달력에서 확인
